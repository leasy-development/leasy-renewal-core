      ...
      <main className="container mx-auto px-4 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Manage your leases and properties from one central location.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Common tasks you can perform to manage your properties.
              </CardDescription>
            </CardHeader>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Apartment 3B - $1,200</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Unit 1A - Kitchen faucet leak</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-medium">Lease renewal signed</p>
                    <p className="text-xs text-muted-foreground">Building C, Unit 2B</p>
