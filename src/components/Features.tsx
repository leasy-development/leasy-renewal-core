...
import { Upload, Wand2, Image as ImageIcon, Share2, BarChart3, Shield, Clock, Globe } from "lucide-react";
const features = [{
  icon: Upload,
  ...
  return <section id="features" className="py-20 lg:py-28 bg-secondary/30">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {features.map((feature, index) => <Card key={index} className="group bg-gradient-card border-border/50 shadow-soft hover:shadow-medium transition-all duration-300 hover:scale-105">
